...
export class InitMigration1758542001581 implements MigrationInterface {
    name = 'InitMigration1758542001581'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flights\` ADD \`departureTime\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`flights\` ADD \`arrivalTime\` datetime NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`payments\` ADD CONSTRAINT \`FK_e86edf76dc2424f123b9023a2b2\` FOREIGN KEY (\`booking_id\`) REFERENCES \`bookings\`(\`booking_id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`tickets\` ADD CONSTRAINT \`FK_cc20985f14524969dddd128efd5\` FOREIGN KEY (\`booking_id\`) REFERENCES \`bookings\`(\`booking_id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`bookings\` ADD CONSTRAINT \`FK_6136a19aecad762acef1a49b083\` FOREIGN KEY (\`flight_id\`) REFERENCES \`flights\`(\`flight_id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flights\` DROP COLUMN \`arrivalTime\``);
        await queryRunner.query(`ALTER TABLE \`flights\` DROP COLUMN \`departureTime\``);
        ...
        await queryRunner.query(`ALTER TABLE \`flights\` ADD \`arrival_time\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`flights\` ADD \`departure_time\` datetime NOT NULL`);
